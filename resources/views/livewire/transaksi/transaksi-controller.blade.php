            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-5 py-4 border-b text-sm text-center">
                    <div class="flex justify-center gap-2">
                        ...
                        <button wire:click="printNota({{ $transaksi->id }})" class="px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 flex items-center gap-1 text-sm shadow-sm transition">
