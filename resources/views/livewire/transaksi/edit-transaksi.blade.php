<div class="relative py-3">
    <div
        class="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
    </div>
    <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
        <h1 class="text-3xl font-extrabold text-center text-gray-900 mb-2">Edit Transaksi</h1>
        <p class="text-center text-gray-600 mb-8">Kode Transaksi: <span class="font-bold text-purple-600">{{ $kode
                }}</span></p>
        ...
        <div class="mb-8">
            <h2 class="text-xl font-semibold text-gray-800 mb-4">Daftar Produk Transaksi</h2>
            ...
            <div class="text-center py-8 bg-gray-50 rounded-lg shadow-inner">
                <p class="text-gray-500 italic">Transaksi ini tidak memiliki produk. Tambahkan produk dari kolom
                    pencarian.</p>
            </div>
            @endif
        </div>
        ...
        <div class="bg-gray-100 p-6 rounded-lg shadow-inner">
            ...
            <div class="mt-8">
                <button wire:click="update" wire:loading.attr="disabled" wire:target="update"
                    class="w-full py-3 px-4 border border-transparent rounded-full shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 transition duration-150 ease-in-out transform hover:scale-105">
                    <span wire:loading.remove wire:target="update">Perbarui Transaksi</span>
