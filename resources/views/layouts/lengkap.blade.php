                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    ...
                                    <img src="{{ asset('modernize/src/assets/images/profile/user-1.jpg') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card overflow-hidden rounded-2">
                            <div class="position-relative">
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('modernize/assets/images/products/s5.jpg') }}"
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card overflow-hidden rounded-2">
                            <div class="position-relative">
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('modernize/assets/images/products/s7.jpg') }}"
                                        class="card-img-top rounded-0" alt="Product Image">
                                </a>
                                <a href="javascript:void(0)"
                                    class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card overflow-hidden rounded-2">
                            <div class="position-relative">
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('modernize/assets/images/products/s11.jpg') }}"
                                        class="card-img-top rounded-0" alt="Product Image">
                                </a>
                                <a href="javascript:void(0)"
                                    class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
