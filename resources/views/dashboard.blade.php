            ...
            <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                    <div class="mb-3 mb-sm-0">
                        <h5 class="card-title fw-semibold">Sales Overview haloooo</h5>
                    </div>
                    <div>
...
<div class="row">
        ...
        <div class="card overflow-hidden rounded-2">
            <div class="position-relative">
                <a href="javascript:void(0)">
                    <img src="{{ asset('modernize/src/assets/images/products/s4.jpg') }}" class="card-img-top rounded-0"
                        alt="Product Image">
                </a>
                <a href="javascript:void(0)"
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card overflow-hidden rounded-2">
            <div class="position-relative">
                <a href="javascript:void(0)">
                    <img src="{{ asset('modernize/src/assets/images/products/s5.jpg') }}" class="card-img-top rounded-0"
                        alt="Product Image">
                </a>
                <a href="javascript:void(0)"
                    class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card overflow-hidden rounded-2">
            <div class="position-relative">
                <a href="javascript:void(0)">
                    <img src="{{ asset('modernize/src/assets/images/products/s7.jpg') }}" class="card-img-top rounded-0"
                        alt="Product Image">
                </a>
                <a href="javascript:void(0)"
                    class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card overflow-hidden rounded-2">
            <div class="position-relative">
                <a href="javascript:void(0)">
                    <img src="{{ asset('modernize/src/assets/images/products/s11.jpg') }}" class="card-img-top rounded-0"
                        alt="Product Image">
                </a>
                <a href="javascript:void(0)"
                    class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3"
